...
$sentencia=$conexion->prepare("SELECT * FROM tbl_autores");
$sentencia->execute();
$lista_de_autores=$sentencia->fetchAll((PDO::FETCH_ASSOC));
  ...
  <div class="card">
    ...
    <div class="table-responsive-sm">
       <table class="table" id="tabla_id">
          ...
          <tbody>
       <?php foreach ($lista_de_autores as $registro) { ?>

             <tr class="">
                <td scope="row"><?php echo $registro['id']?></td>
                <td scope="row"><?php echo $registro['nombre']?></td>
                <td scope="row"><?php echo $registro['nacionalidad']?></td>
                <td scope="row"><?php echo $registro['f_nacimiento']?></td>
